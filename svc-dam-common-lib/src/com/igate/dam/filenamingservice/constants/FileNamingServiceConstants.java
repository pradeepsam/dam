package com.igate.dam.filenamingservice.constants;

public class FileNamingServiceConstants {
	
	public static String DROOLS_AGENT_SCANDIRECTORY = "drools.agent.scanDirectories";
	public static String KNOWLEDGE_AGENT = "knowledge Agent";
	public static String FALSE_VAL = "false";
